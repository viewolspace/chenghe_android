...
import com.parttime.orange.contract.LoginContract;
import com.parttime.orange.presenter.LoginPresenter;
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.iv_close:
                ...
                break;
            case R.id.tv_web1:
                WebActivity.start(LoginActivity.this,"http://www.chengheed.com/xy/mj_yhxy.htm");
                break;
            case R.id.tv_web2:
                WebActivity.start(LoginActivity.this,"http://www.chengheed.com/xy/mj_yszc.htm");
                break;

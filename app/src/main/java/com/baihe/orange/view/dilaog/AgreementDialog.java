package com.baihe.orange.view.dilaog;
...
import com.baihe.base.dialog.BaseDialog;
...
public class AgreementDialog extends BaseDialog {
    ...
    protected void initView(View root) {
        ...
        tvContent.setText(Html.fromHtml("&emsp;&emsp;感谢您下载蜜桔兼职！" +
                "在您开始使用本软件前，请您务必仔细审慎阅读、充分理解软件许可及服务协议和隐私政策各条款，包括但不限于用户注意事项、用户行为以及为了向你提供服务而收集、使用、存储你个人信息的情况等。" +
                "您可以阅读<a href='http://www.chengheed.com/xy/mj_yhxy.htm'>《蜜桔兼职用户协议》</a> 与<a href='http://www.chengheed.com/xy/mj_yszc.htm'>《蜜桔兼职隐私政策》</a> 了解详细信息。" +
                "点击同意即表示您已阅读并同意<a href='http://www.chengheed.com/xy/mj_yhxy.htm'>《蜜桔兼职用户协议》</a> 与<a href='http://www.chengheed.com/xy/mj_yszc.htm'>《蜜桔兼职隐私政策》</a> 。" ));
